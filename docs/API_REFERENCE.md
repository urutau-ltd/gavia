...
behavior in handlers with shared helpers from [`internal/ui/request.go`](../internal/ui/request.go).
...
- unsafe browser requests also require a matching `_csrf` form field or
  `X-CSRF-Token` header, enforced by [`internal/csrf/service.go`](../internal/csrf/service.go)
